...
--
-- Dumping routines for database 'new_database'
--
...
IN contact_fname VARCHAR(45),
IN contact_lname VARCHAR(45),
IN contact_email VARCHAR(45),
IN contact_address VARCHAR(60),
IN contact_photo VARCHAR(64),
IN action VARCHAR(20),
OUT status VARCHAR(3)
)
BEGIN
CASE action
WHEN 'ADD' THEN 

INSERT INTO contact_info (contact_first_name, contact_last_name, contact_email_address, contact_address) VALUES ( contact_fname, contact_lname, contact_email, contact_address);
INSERT INTO contact_photo SELECT MAX(contact_id), contact_photo FROM contact_info;
SET status = 'OK';
END CASE;
END ;;
DELIMITER ;
...
IN user_fname VARCHAR(45),
IN user_lname VARCHAR(45),
IN user_email VARCHAR(45),
IN user_passw VARCHAR(60),
IN action VARCHAR(20),
OUT status VARCHAR(3)
)
BEGIN
CASE action
WHEN 'ADD' THEN 
INSERT INTO user_info (user_first_name, user_last_name, user_email_address) VALUES ( user_fname, user_lname, user_email );
INSERT INTO user_passw SELECT MAX(user_ID), user_email, user_passw FROM user_info;
SET status = 'OK';
END CASE;
END ;;
DELIMITER ;
...
-- Dump completed on 2022-10-17 21:28:44
